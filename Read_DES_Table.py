...
if showDObject == '1':
    ...
    data_des = data_des.unique(data_des, keys='ObjectName') #not working after updating astropy
if showDDates == '1':
    data_des = data_des.group_by ('JulienDate')
    if showDObject =='1':
        print ("error, please show your filters configuration")
    else:
        data_des = data_des.unique(data_des, keys = 'JulienDate')#not working after updating astropy
if showDFilters == '1':
    data_des = data_des.group_by('BAND')
    if showDObject =='1':
        print ("error, please show your filters configuration")
    else:
        data_des = data_des.unique(data_des, keys = 'BAND')#not working after updating astropy
